...
int main() {
	...
	// From user input, obtain the number of simulation iterations, grid size, average demand, number of parking lots, info about parking lot capacities, number of destinations, and whether destinations probabilities are equal or random
